...
# email (отправка писем) - для разработки используем консоль
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'  # ИЗМЕНЕНО
...
BATON = {
    ...
    'COPYRIGHT': 'copyright © 2024 Retail Network',
    'POWERED_BY': '<a href="https://github.com/your-repo">Retail Network Team</a>',
}

# Упрощенное кэширование (без Redis)
CACHES = {
    'default': {
